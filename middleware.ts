...
export const config = {
  matcher: [
    ...
    */
    "/((?!$|public/|auth/|_error|_not-found|api/auth/|api/scores/|api/customs/|api/match/|about$|about/|privacy-policy$|privacy-policy/|support$|support/|google17b609747b541c79\\.html$|stream/overlay/|img/|svg/|stream/result/).*)",
  ],
};
